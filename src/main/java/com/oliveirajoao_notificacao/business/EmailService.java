package com.oliveirajoao_notificacao.business;

import com.oliveirajoao_notificacao.business.dto.TarefasDTO;
import com.oliveirajoao_notificacao.infrastructure.exceptions.EmailException;
...
public class EmailService {
    ...
    @Value("S{envio.email.nomeRemetente}")
    ...
    public void enviaEmail(TarefasDTO dto){
        ...
        try {
            ...
            mimeMessageHelper.setSubject("Notificao de tarefa");
